...
describe('Home check text', () => {
  it('should render heading', () => {
    ...
    // label
    const textField = screen.getByText('Compound ID')
  ...
  it('should update the TextField when typed into', async () => {
    ...
    const autocomplete = await screen.findByLabelText('Compound ID')
    fireEvent.click(autocomplete)

    let input = screen.getByLabelText('Compound ID', { selector: 'input' })
