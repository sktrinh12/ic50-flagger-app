...
select_columns = {
    ...
    "metabolic_stability": "CYP, RESULT, COMMENTS, EXPERIMENT_DATE, DATE_HIGHLIGHT",
    "pxr": "FOLD_INDUCTION, UNIT, CONC, EXPERIMENT_DATE, DATE_HIGHLIGHT",
    "permeability": "BATCH_ID, A_B, B_A, EFFLUX_RATIO, CELL_TYPES, PCT_RECOVERY_AB, EXPERIMENT_DATE, DATE_HIGHLIGHT",
    "protein_binding": "SPECIES, MATRIX, PCT_UNBOUND, EXPERIMENT_DATE, DATE_HIGHLIGHT",
    "solubility": "CONDITION, RESULT, EXPERIMENT_DATE, DATE_HIGHLIGHT",
    "stability": "MATRIX, SPECIES, RESULT_TYPE_1, RESULT_1, EXPERIMENT_DATE, DATE_HIGHLIGHT",
}
